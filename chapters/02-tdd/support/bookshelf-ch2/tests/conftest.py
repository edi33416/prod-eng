...
def db_conn(tmp_path: pytest.TempPathFactory) -> sqlite3.Connection:
    conn = sqlite3.connect(tmp_path / "test.db")  # type: ignore[arg-type]
...
def populated_db(db_conn: sqlite3.Connection, sample_books: list[BookCreate]) -> sqlite3.Connection:
    # TODO: After implementing services.create_book and services.add_review,
    #       this fixture will insert all sample_books and some reviews.
